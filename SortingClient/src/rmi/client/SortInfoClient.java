...
public class SortInfoClient {
    public static void main(String[] args) {
        try {
            System.out.println("client.SortInfoClient> get product info with id '123'...");
            ...
            System.out.println("client.SortInfoClient> production info received: ");
            for (int x : integers) System.out.println(x + ", ");
        } catch (Exception e) {
            System.err.println("client.SortInfoClient> RemoteDate exception: " + e.getMessage());
            e.printStackTrace();
